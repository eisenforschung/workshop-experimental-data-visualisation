...
if [! -d ${HOME}/workshop-experimental-data-visualisation] ; then 
    cd $HOME
    git clone --recurse-submodules https://github.com/eisenforschung/workshop-experimental-data-visualisation ${HOME}/workshop-experimental-data-visualisation
fi
